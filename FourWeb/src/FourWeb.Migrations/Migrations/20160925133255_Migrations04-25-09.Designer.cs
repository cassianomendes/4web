...
namespace FourWeb.Migrations.Migrations
{
    ...
    [Migration("20160925133255_Migrations04-25-09")]
    partial class Migrations042509
    {
            ...
            modelBuilder.Entity("FourWeb.Migrations.DatabaseModel.SubCategories", b =>
                {
                    ...
                    b.Property<int?>("SubCategoriesIdId");

                    b.HasKey("Id");

                    b.HasIndex("ChildCategoryIdId");

                    b.HasIndex("SubCategoriesIdId");
            ...
            modelBuilder.Entity("FourWeb.Migrations.DatabaseModel.SubCategories", b =>
                {
                    ...
                    b.HasOne("FourWeb.Migrations.DatabaseModel.Category", "SubCategoriesId")
                        .WithMany()
                        .HasForeignKey("SubCategoriesIdId");
                });
