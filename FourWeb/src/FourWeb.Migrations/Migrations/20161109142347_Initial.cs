    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeaturedShowCase", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: true),
                    SecurityCode = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(nullable: true),
                    FeaturedShowCaseId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Product_FeaturedShowCase_FeaturedShowCaseId",
                        column: x => x.FeaturedShowCaseId,
                        principalTable: "FeaturedShowCase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecialOfferProduct", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TechnicalDetail_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Order_DiscountCoupon_DiscountCouponId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_DiscountCouponId",
                table: "Order",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_FeaturedShowCaseId",
                table: "Product",
                column: "FeaturedShowCaseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecialOfferProduct_SpecialOfferId",
                table: "SpecialOfferProduct",
