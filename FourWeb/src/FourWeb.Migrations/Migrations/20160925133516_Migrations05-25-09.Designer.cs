...
namespace FourWeb.Migrations.Migrations
{
    ...
    [Migration("20160925133516_Migrations05-25-09")]
    partial class Migrations052509
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("FourWeb.Migrations.DatabaseModel.SubCategories", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("ParentCategoriesIdId");

                    b.HasKey("Id");

                    b.HasIndex("ChildCategoryIdId");

                    b.HasIndex("ParentCategoriesIdId");
            ...
            modelBuilder.Entity("FourWeb.Migrations.DatabaseModel.SubCategories", b =>
                {
                    b.HasOne("FourWeb.Migrations.DatabaseModel.Category", "ChildCategoryId")
                        .WithMany("SubCategories")
                        .HasForeignKey("ChildCategoryIdId");

                    b.HasOne("FourWeb.Migrations.DatabaseModel.Category", "ParentCategoriesId")
                        .WithMany()
                        .HasForeignKey("ParentCategoriesIdId");
                });
